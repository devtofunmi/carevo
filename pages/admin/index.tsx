...
import { adminStats, systemMetrics, mockAdminUsers, recentActivity } from '@/lib/adminMockData';
...
export default function AdminDashboard() {
  ...
  const getActivityIcon = (type: string) => {
    switch (type) {
      ...
      case 'user_upgrade': return '⬆️';
      case 'placement_success': return '🎉';
      default: return '📋';
    }
  };
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-600">{systemMetrics.jobBoardsMonitored}</div>
              <div className="text-sm text-gray-500">Job Boards Monitored</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-green-600">{systemMetrics.jobsScannedToday.toLocaleString()}</div>
              <div className="text-sm text-gray-500">Jobs Scanned Today</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-600">{systemMetrics.applicationsProcessed.toLocaleString()}</div>
              <div className="text-sm text-gray-500">Applications Processed</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-green-600">{systemMetrics.systemUptime}</div>
              <div className="text-sm text-gray-500">System Uptime</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-yellow-600">{systemMetrics.apiResponseTime}ms</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-gradient-to-r from-green-500 to-blue-600 rounded-xl p-6 text-white">
            ...
            <div className="text-3xl font-bold mb-2">${adminStats.monthlyRevenue.toLocaleString()}</div>
          ...
          <div className="bg-gradient-to-r from-purple-500 to-pink-600 rounded-xl p-6 text-white">
            ...
            <div className="text-3xl font-bold mb-2">{adminStats.averageMatchScore}%</div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <button className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              <span className="text-2xl mr-3">🔗</span>
              <div className="text-left">
                <div className="font-medium">Job Board APIs</div>
                <div className="text-sm text-gray-500">Manage integrations</div>
              </div>
            </button>
          </div>
        </div>
